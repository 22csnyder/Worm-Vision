...
#H_init = [np.hstack([y.ravel(), np.random.randint(2, 4, size=3 * 3)]) for y in Y]
plot_boxes(H_init, title="Top: Random initial hidden states. Bottom: Ground truth labeling.")
