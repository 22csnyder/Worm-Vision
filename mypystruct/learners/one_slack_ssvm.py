...
class OneSlackSSVM(BaseSSVM):
    ...
    * Joachims, Thorsten and Finley, Thomas and Yu, Chun-Nam John:
    ...
    def __init__(self, model, max_iter=10000, C=1.0, check_constraints=False,
        ...
        #additional, stored only if logger is not None.
        self.Yhat_log=[]#The Yhat that create the constraints
        self.w_log=[]
...
#        print 'within _find_new_constraint'
...
#        print Y_hat
    ...
    def fit(self, X, Y, constraints=None, warm_start=False, initialize=True):
        ...
        """
#        print 'start of fit in one-slack'
#        print 'Y:'
#        print Y
...
#            print 'model is initialized. Called in one_slack_svm.py'
...
#                        print Y[0].shape
                ...
                if self.verbose:
                    print'Y_hat'
                    print Y_hat[0].reshape(10,15)
                    print 'djoint_feature'
                    print djoint_feature
                    print 'loss_mean'
                    print loss_mean
...
#                print constraints
                ...
                self.last_slack_ = np.max([(-np.dot(self.w, djoint_feature) + loss_mean)
                                           for __djoint_feature, __loss_mean in constraints])
...
#                print 'constraints__'
#                print self.constraints_
                if self.logger is not None:
                    self.logger(self, iteration)
                    self.Yhat_log.append(Y_hat)
