...
#        print 'up',isinstance(unary_potentials,np.ndarray)
#        print 'y',isinstance(y,np.ndarray)
#        print unary_potentials.shape
#        print 'Y in crf ',y.shape
#        print np.asarray(y).shape #Needs to be (150,0) instead of (10,15)#problem with template
#        print self.class_weight.shape
#        print 'up',isinstance(unary_potentials,np.ndarray)
        loss_augment_unaries(unary_potentials, np.asarray(y), self.class_weight)
#        loss_augment_unaries(np.asarray(unary_potentials,dtype=np.float64), np.asarray(y), self.class_weight)
